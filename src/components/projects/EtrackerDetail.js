  ...
  return (
    <Modal onClose={props.onClose}>
      ...
      <div className={classes.content}>
        ...
        <p>A one-page expense tracker App built with React.js and designed for 
          tablet and mobile use. The technologies used include React Hooks, 
          Local Storage, Context API, and Styled Components. 
        </p>
        <a href="https://expense-tracker-9b607.web.app" target="_blank" rel="noopener noreferrer"><FiExternalLink /> Demo</a>
        <a href="https://github.com/MayraBorgonovo/expense-tracker" target="_blank" rel="noopener noreferrer"><FiGithub /> Source</a>
      </div>
    </Modal>
  )
}
